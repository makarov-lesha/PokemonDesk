...
var tsSum = function (arr) { return arr.reduce(function (a, b) { return a + b; }); };
tsSum([1, 5]);
...
//Tuples
var tsNextArr = ['1', 2];
var a = tsNextArr[0], b = tsNextArr[1];
var tsObj = {
    name: 'Alexey',
    birthday: 35
};
...
var ArrowFunc = function () { return null; };
//(Lesson 6)
//Generics
...
// }
var tsArr = [1, 3, 4];
tsArr.map(function (i) { return i + 1; });
tsArr.map(function (i) { return 'df'; });
function getLen(arr) {
    return arr.length;
}
getLen([1, 2, 3]);
